// QuizManager.tsx - النسخة المحسنة مع إمكانية تعطيل المحاولات
...
export default function QuizManager({ user }: QuizManagerProps) {
  ...
  const quizStats = useMemo(() => {
    ...
    return {
      ...
      isDisabled: quiz?.maxAttempts === 0 // إضافة خاصية التعطيل
    };
  ...
  const handleToggleQuizAccess = useCallback(async () => {
    ...
    const newMaxAttempts = quiz.maxAttempts === 0 ? 3 : 0;
                ...
                {!editingQuiz && (
                  <>
                    ...
                    <button
                      ...
                      className={`inline-flex items-center gap-1 sm:gap-2 px-3 py-1.5 sm:px-4 sm:py-2 text-white text-xs sm:text-sm font-semibold rounded-lg transition-all duration-200 shadow-md ${
                        isQuizDisabled 
                    ...
                    >
                      ...
                      {isQuizDisabled ? 'تفعيل المسابقة' : 'تعطيل المسابقة'}
                    </button>
                    ...
                    >
                      ...
                      {reviewMode ? 'إيقاف المراجعة' : 'تفعيل المراجعة'}
                    </button>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-6 gap-3 mt-4">
                ...
                <div className={`rounded-xl p-3 text-center border ${
                  ...
                  <div className={`text-lg font-bold ${
                    ...
                    {isQuizDisabled ? 'معطلة' : quizStats.maxAttempts}
                  </div>
                  <div className={`text-xs ${
                    isQuizDisabled ? 'text-red-600' : 'text-orange-600'
                  }`}>
                    {isQuizDisabled ? 'المسابقة معطلة' : 'المحاولات المسموحة'}
                  </div>
                </div>
                <div className={`rounded-xl p-3 text-center border ${
                  reviewMode 
            ...
            <div className="bg-white rounded-2xl shadow-lg p-4 mb-4 border border-blue-200">
              <form onSubmit={handleUpdateQuiz} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">عدد المحاولات المسموحة (0 لتعطيل المسابقة)</label>
                    <input
                      type="number"
                      min="0"
                      max="10"
                ...
                <div className="space-y-4">
                  <div>
                    <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-2">
                      عدد المحاولات المسموحة (0 لتعطيل المسابقة)
                    </label>
                    <input
                      type="number"
                      min="0"
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-1">0 = تعطيل المسابقة | 1-10 = عدد المحاولات المسموحة</p>
                  </div>
                  ...
                  <div className="text-xs text-gray-500 bg-gray-50 p-2 rounded-lg">
                    ...
                    <p>• يمكن للمستخدمين رؤية المسابقة ولكن لا يمكنهم المشاركة إذا كانت معطلة</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          {quizzes.map((quiz) => {
            ...
            return (
              <div key={quiz._id} className={`bg-white rounded-2xl shadow-lg overflow-hidden border transition-all duration-300 hover:shadow-xl ${
                isQuizDisabled ? 'border-red-300 bg-red-50' : 'border-gray-200'
              }`}>
                {quiz.imageUrl && (
                  <div className="w-full h-28 sm:h-40 flex justify-center bg-gray-100 relative">
                    <img 
                      src={quiz.imageUrl} 
                      alt={quiz.title} 
                ...
                <div className="p-3 sm:p-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex gap-1">
                      {isQuizDisabled && (
                        <span className="bg-red-100 text-red-800 text-xs font-semibold px-2 py-1 rounded-lg">
                          معطلة
                        </span>
                      )}
                  ...
                  <div className="flex gap-1 sm:gap-2">
                    <button
                      ...
                      className={`flex-1 py-1.5 px-2 rounded-lg text-xs font-semibold transition-all duration-200 flex items-center justify-center gap-1 ${
                        isQuizDisabled 
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-3 z-50">
            <div className="bg-white rounded-2xl p-4 sm:p-6 w-full max-w-md border border-blue-200">
              ...
              <form onSubmit={handleCreateQuiz} className="space-y-3">
                ...
                <div>
                  <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">عدد المحاولات المسموحة (0 لتعطيل المسابقة)</label>
                  <input
                    type="number"
                    min="0"
                    max="10"
